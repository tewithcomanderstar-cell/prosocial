...
เป้าหมาย: เขียนแคปชันสั้น 2 บรรทัด ที่อ่านแล้ว "เหมือนคนใช้จริงมาเล่าให้เพื่อนฟัง" ไม่ใช่โฆษณา/โบรชัวร์

โครงที่ต้องการ:
- 2 บรรทัด รวมไม่เกิน 40 คำ
- บรรทัดแรก: เปิดด้วยสถานการณ์/ความรู้สึก/นิสัยจริงของคนกลุ่มเป้าหมาย (จาก painPoint หรือ triggerMoment) ดึงให้คนรู้สึก "ใช่เลย นี่แหละเรา"
- บรรทัดสอง: เล่าว่าพอมีของชิ้นนี้แล้วชีวิตเปลี่ยนยังไงแบบ "เห็นภาพ/รูปธรรม" (ผลลัพธ์จริง จังหวะที่ได้ใช้) ไม่ใช่ลิสต์สเปก
- พูดให้ตรงกับสินค้าจริงและคนใช้จริง เช่น ถ้าเป็นของคุณแม่ปั๊มนมก็พูดกับคุณแม่ ถ้าเป็นของในครัวก็พูดถึงจังหวะทำกับข้าวจริง

ทำให้ฟังเป็นธรรมชาติ (สำคัญที่สุด):
- เขียนเหมือนพิมพ์คุยกับเพื่อน ภาษาทั่วไป ไม่เป็นทางการ
- สลับวิธีเปิดเรื่องให้หลากหลาย อย่าใช้โครง "ปัญหา → ช่วยแก้" ซ้ำเดิมทุกครั้ง บางทีเปิดด้วยจังหวะในชีวิต ความเซอร์ไพรส์ หรือสิ่งที่เพิ่งค้นพบก็ได้
- ห้ามใช้เครื่องหมาย "/" เด็ดขาด (เขียนเป็นคำพูดธรรมดาแทน เช่น "ทั้งร้อนทั้งเย็น")
- ห้ามเขียนเหมือนสเปกสินค้า เช่น "แยกพื้นที่ย่างและช่องรับน้ำมัน" ให้เปลี่ยนเป็นผลลัพธ์ที่คนรู้สึกได้ เช่น "ย่างไปจิ้มจุ่มไป โต๊ะไม่เลอะ เก็บล้างง่ายด้วย"
- Emoji 0–2 ตัว วางตรงที่คนจริงจะใส่ ไม่ต้องลงหน้าเศร้า/เหนื่อยทุกครั้ง สลับอารมณ์ได้
- ห้ามขึ้นต้นด้วยชื่อสินค้า
- ห้ามใช้คำโฆษณาแข็งๆ: สินค้าคุณภาพดี, คุ้มค่า, เหมาะสำหรับ, ใช้งานได้หลากหลาย, ตอบโจทย์, ไม่ควรพลาด, รีบเลย
- ห้ามใส่ราคา คะแนนรีวิว หรือ URL (ระบบเติม link ให้เอง)
- ใช้ข้อมูลจริงจาก painPoint / triggerMoment / mainPurpose / targetCustomer เท่านั้น ห้ามแต่งสเปกเพิ่ม

ตัวอย่างที่ฟังดูเหมือนคนจริง (สังเกตว่าโครงไม่ซ้ำกัน):
- "ปั๊มนมเก็บไว้เยอะ แต่พาออกนอกบ้านทีไรก็กลัวนมเสีย 🥲\\nใส่น้ำแข็งตอนเช้า ลากยาวทั้งวันนมยังเย็นกริบ อุ่นใจขึ้นเยอะ"
- "ชงกาแฟแก้วโปรดตอนเช้า กว่าจะได้จิบจริงๆ ก็เย็นซะแล้ว\\nกระบอกนี้เก็บร้อนถึงบ่ายเลย จิบตอนดึกยังอุ่นอยู่ ☕"
- "เพื่อนมาบ้านทีไร ห้องโล่งๆ ดูไม่มีอะไรเลย\\nแขวนรูปเหนือโซฟารูปเดียว ห้องดูมีราคาขึ้นมาทันตา ✨"

Output Format (JSON):
{
  "captionText": "บรรทัดแรก\\nบรรทัดสอง",
...
Hard Rules:
- captionText ต้องมี 2 บรรทัดพอดี คั่นด้วย \\n หนึ่งตัว
- ห้ามขึ้นต้นด้วยชื่อสินค้า และห้ามมีเครื่องหมาย "/"
- รวมทั้งหมดไม่เกิน 40 คำ
- อ่านแล้วต้องเหมือนคนใช้จริงเล่า ไม่ใช่โฆษณา`;
      ...
      input: [
        {
          role: "system",
          content:
            "คุณคือคนไทยที่ใช้สินค้าจริงแล้วมาเล่าให้เพื่อนฟังบน Facebook เขียนแคปชันสั้น 2 บรรทัด รวมไม่เกิน 40 คำ ภาษาธรรมชาติเหมือนพิมพ์คุยกับเพื่อน ไม่ใช่โฆษณา ห้ามใช้เครื่องหมาย '/' สลับวิธีเปิดเรื่องให้หลากหลาย ห้าม Bullet ห้าม Hashtag ห้ามใส่ราคาหรือ URL Return strict JSON only."
        },
        { role: "user", content: prompt }
      ]
    })
