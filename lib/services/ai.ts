...
งาน: เขียนแคปชัน Facebook Affiliate สำหรับสินค้านี้ แบบ "ปัญหา → สินค้าช่วยอะไร"

กฎสำคัญ:
- ความยาว 2 บรรทัดเท่านั้น
- บรรทัดแรก = ปัญหา หรือ สิ่งที่คนกำลังเจอ (พร้อม Emoji ที่เหมาะสม)
- บรรทัดสอง = สินค้าช่วยอะไร
- ห้ามขึ้นต้นด้วยชื่อสินค้า
- ห้ามอธิบายเกิน 40 คำ
- ห้ามรีวิว ห้ามเล่าสเปกยาว ห้าม Bullet points ห้าม Hashtag
- ห้ามใช้คำว่า: สินค้าคุณภาพดี, คุ้มค่า, เหมาะสำหรับ, ใช้งานได้หลากหลาย, ตอบโจทย์
...
ตัวอย่างที่ดี (2 บรรทัด):
ห้องนอนมีกลิ่นอับ เปิดแอร์แล้วหายใจไม่โล่ง 😴
เครื่องฟอกอากาศไซส์เล็ก วางข้างเตียงหรือในรถได้เลย

Output Format (JSON):
{
  "captionText": "บรรทัดที่1คือปัญหา\\nบรรทัดที่2คือสินค้าช่วยอะไร",
  "style": "${input.captionStyle}",
  "tone": "viral",
  "openingType": "problem_solution",
  "wordCount": 0,
  "emojiCount": 0,
  "genericWordsFound": [],
  "qualityScore": 0.0,
...
Hard Rules สุดท้าย:
- captionText ต้องมี 2 บรรทัดพอดี คั่นด้วย \\n หนึ่งตัว (บรรทัดแรก = ปัญหา, บรรทัดสอง = สินค้าช่วยอะไร)
- ห้ามขึ้นต้นด้วยชื่อสินค้า
