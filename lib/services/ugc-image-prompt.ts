...
const UGC_BASE_PROMPT = [
  ...
  "Use the original product as the source of truth: preserve product pixels as much as possible and do not change product shape, color, logo, material, model, proportions, label placement, packaging text placement, or visible details.",
  "Do not invent a new product, do not rewrite product packaging, do not repair labels, and do not create a fake version of the product.",
  ...
  "Do not generate Thai text, English text, captions, badges, panels, banners, UI elements, text boxes, dark bars, labels, callouts, or readable typography inside the image.",
  "Do not add any new explanatory text to the image. The image must be clean UGC photography only."
].join(" ");
...
function promptForConcept(input: {
  ...
  return {
    ...
    prompt: [
      ...
      "No readable text should be generated by the image model. Keep existing product packaging and brand text exactly as close to the reference as possible; do not invent, translate, repair, or rewrite labels. If the label cannot be preserved, prefer leaving the original image unchanged instead of hallucinating text.",
      ...input.instructions,
...
export function buildUgcShopeeImagePromptSet(
  ...
  return {
    ...
    consistencyInstructions: [
      ...
      "Do not ask the image model or server renderer to draw Thai captions, badges, panels, or explanatory text on the image. Shopee Affiliate images must be clean photos with no added text."
    ],
    prompts,
